...
export default function UploadDesignModal({ open, onClose }: UploadDesignModalProps) {
  if (!open) {
    return null;
  }
    ...
    >
      ...
      >
        ...
        <div className="px-8 py-8">
          ...
          <button
            type="button"
            className="mt-6 flex h-[209px] w-full flex-col items-center justify-center rounded-[13px] border-[2px] border-dashed border-[#d8c5ff] bg-[#faf8ff] text-center"
          >
            <UploadArrowIcon />
