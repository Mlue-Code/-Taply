...
export default function WorkspaceProjectCard({ project, onClick }: WorkspaceProjectCardProps) {
  return (
    <button
      type="button"
      onClick={() => onClick(project)}
      className="group flex min-h-[148px] flex-col justify-between rounded-[13px] border border-[#ece6f7] bg-white p-4 text-left shadow-[0_12px_28px_rgba(26,15,54,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_32px_rgba(26,15,54,0.12)]"
    >
      <div>
